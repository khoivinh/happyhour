/** Settings gear. Stands in for the "Sharing Options" label on phones, where the full label is too
 *  wide to sit beside Done / Copy Link / Share on one row.
 *
 *  `currentColor`, not the source SVG's hardcoded #000: the Commit Bar's foreground is a per-theme
 *  token (white on the dark bar, near-black on the light and happy ones), so a fixed black would be
